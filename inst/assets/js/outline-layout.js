/* Outline rail geometry: the pure part of the outline.
 *
 ...
 * by the browser. `outline.js` owns everything that draws.
 *
 * model = {
...
(function (root, factory) {
  ...
  // `railModel`). Naming them is what lets the outline offer the one-click fix:
